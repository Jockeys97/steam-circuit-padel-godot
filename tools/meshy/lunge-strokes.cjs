...
async function ensureRig(){
 ...
 if(d.result&&d.result.rigged_character_glb_url)await download(d.result.rigged_character_glb_url,'fiamma-rig.glb');
 return state.rig.id;
}
