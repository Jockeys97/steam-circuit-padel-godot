...
## How long the AI is holding a "let it bounce" decision it already made
## (`sim.gd:ai_contact_plan`). Zero means no commitment. Reset with the read delay.
var aiDeferTimer: float = 0.0
