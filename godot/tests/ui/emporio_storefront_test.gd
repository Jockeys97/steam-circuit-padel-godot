...
func _run() -> void:
	...
	audit.check_true(vocal_cards.size() == 19, "shop/vocal_filter_nineteen_cards")
	...
	audit.check_eq(Catalog.price_of("ost_vocal_gleiches_blut"), 400, "shop/vocal_gleiches_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_tie_break_burn"), 400, "shop/vocal_tie_break_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_nullpunkt"), 400, "shop/vocal_nullpunkt_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_double_rebond"), 400, "shop/vocal_double_rebond_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_oltre_il_vetro"), 400, "shop/vocal_oltre_il_vetro_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_por_tres"), 400, "shop/vocal_por_tres_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_bandeja_chic"), 400, "shop/vocal_bandeja_chic_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_bandeja_chic_catchy"), 400, "shop/vocal_bandeja_chic_catchy_price_400")
	audit.check_eq(Catalog.price_of("ost_vocal_bandeja_chic_rap"), 400, "shop/vocal_bandeja_chic_rap_price_400")
	...
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_gleiches_blut"), 50.0, "sample/vocal_gleiches_offset_50")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_tie_break_burn"), 40.0, "sample/vocal_tie_break_offset_40")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_maschine_jagd"), 35.0, "sample/vocal_maschine_offset_35")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_schwarzmarkt"), 30.0, "sample/vocal_schwarzmarkt_offset_30")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_nullpunkt"), 20.0, "sample/vocal_nullpunkt_offset_20")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_zheleznaia_volya"), 50.0, "sample/vocal_zheleznaia_offset_50")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_double_rebond"), 45.0, "sample/vocal_double_rebond_offset_45")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_oltre_il_vetro"), 45.0, "sample/vocal_oltre_il_vetro_offset_45")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_padelista_energy"), 15.0, "sample/vocal_padelista_offset_15")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_balle_de_match"), 60.0, "sample/vocal_balle_de_match_offset_60")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_por_tres"), 35.0, "sample/vocal_por_tres_offset_35")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_bandeja_chic"), 25.0, "sample/vocal_bandeja_chic_offset_25")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_bandeja_chic_catchy"), 25.0, "sample/vocal_bandeja_chic_catchy_offset_25")
	audit.check_eq(Soundtrack.preview_offset("ost_vocal_bandeja_chic_rap"), 30.0, "sample/vocal_bandeja_chic_rap_offset_30")
