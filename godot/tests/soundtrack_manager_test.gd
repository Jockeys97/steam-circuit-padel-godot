...
func _run() -> void:
	...
	_assert_eq(SoundtrackManager.track_id_for_context("vocal_gleiches_blut"), "ost_vocal_gleiches_blut", "Context vocal_gleiches_blut maps to ost_vocal_gleiches_blut")
	_assert_eq(SoundtrackManager.track_id_for_context("vocal_tie_break_burn"), "ost_vocal_tie_break_burn", "Context vocal_tie_break_burn maps to ost_vocal_tie_break_burn")
	_assert_eq(SoundtrackManager.track_id_for_context("vocal_maschine_jagd"), "ost_vocal_maschine_jagd", "Context vocal_maschine_jagd maps to ost_vocal_maschine_jagd")
	_assert_eq(SoundtrackManager.track_id_for_context("vocal_schwarzmarkt"), "ost_vocal_schwarzmarkt", "Context vocal_schwarzmarkt maps to ost_vocal_schwarzmarkt")
	_assert_eq(SoundtrackManager.track_id_for_context("vocal_nullpunkt"), "ost_vocal_nullpunkt", "Context vocal_nullpunkt maps to ost_vocal_nullpunkt")
	_assert_eq(SoundtrackManager.track_id_for_context("vocal_zheleznaia_volya"), "ost_vocal_zheleznaia_volya", "Context vocal_zheleznaia_volya maps to ost_vocal_zheleznaia_volya")
	_assert_eq(SoundtrackManager.track_id_for_context("vocal_double_rebond"), "ost_vocal_double_rebond", "Context vocal_double_rebond maps to ost_vocal_double_rebond")
	...
	_assert_eq(SoundtrackManager.track_id_for_context("iron_juggernaut"), "ost_iron_juggernaut", "Context iron_juggernaut maps to ost_iron_juggernaut")
	_assert_eq(SoundtrackManager.track_id_for_context("thunder_strike"), "ost_thunder_strike", "Context thunder_strike maps to ost_thunder_strike")
	...
	_assert_eq(SoundtrackManager.preview_offset("ost_vocal_gleiches_blut"), 50.0, "Gleiches Blut preview offset is 50.0s")
	_assert_eq(SoundtrackManager.preview_offset("ost_vocal_tie_break_burn"), 40.0, "Tie-Break Burn preview offset is 40.0s")
	_assert_eq(SoundtrackManager.preview_offset("ost_vocal_maschine_jagd"), 35.0, "Maschine Jagd preview offset is 35.0s")
	_assert_eq(SoundtrackManager.preview_offset("ost_vocal_schwarzmarkt"), 30.0, "Schwarzmarkt preview offset is 30.0s")
	_assert_eq(SoundtrackManager.preview_offset("ost_vocal_nullpunkt"), 20.0, "Nullpunkt preview offset is 20.0s")
	_assert_eq(SoundtrackManager.preview_offset("ost_vocal_zheleznaia_volya"), 50.0, "Zheleznaia Volya preview offset is 50.0s")
	_assert_eq(SoundtrackManager.preview_offset("ost_vocal_double_rebond"), 45.0, "Double Rebond preview offset is 45.0s")
